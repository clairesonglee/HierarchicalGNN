...
# Local imports
sys.path.append("../..")
from utils import TrackMLDataset, TrackMLSuperDataset, load_dataset_paths, FRNN_graph, graph_intersection
from tracking_utils import eval_metrics
from supergMRT.supergmrt_utils import transfer_params

class supergMRTBase(LightningModule):
    def __init__(self, hparams):
        ...
        self.fd = open('super_gmrt_epoch_times.csv','w') 
        header = ['Epoch', 'Time']
    ...
    def on_train_epoch_end(self):
        ...
        self.log("pooling_time", pooling_time)
